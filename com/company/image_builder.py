...
bst = xgb.Booster(model_file='/home/anujjalan/learning/deploy/latest.model')
#plot_importance(bst)
plot_tree(bst, num_trees=5)
#pyplot.show()
#pyplot.figure(figsize=(100, 100))
pyplot.savefig('/home/anujjalan/learning/deploy/latest_model.png', format='png', dpi=2000)
